import "./properitiessaleedit.css";
...
export default function Page18() {
  ...
  const handleSubmit = async (event) => {
    ...
    request.append('payment', payment)
    request.append('delivery_date', delivery_date)
    request.append('area', area)
    request.append('delivery_term', delivery_term)
    const response = await API.editRequest(PROPERTIES_SALES_URL, location.state.ad_id, Edit, request);
  ...
  useEffect(()=>{
    ...
    .then(response => {
      ...
      setPayment(response.ad_id.payment)
              ...
              <form onSubmit={handleSubmit} className="inputs ">
                ...
                <div className="type">
                  ...
                  <div className="input position-relative d-flex ">
                    {<input type="text" value="عقارات للبيع" /> }
                ...
                <div className="search mt-3 mb-2 reset-inputs">
                  ...
                  <div className="inputs d-grid-2">
                    ...
                    <div className="input position-relative d-flex ">
                      <input type="text" placeholder="تاريخ التسليم" 
                      value={delivery_date} onChange={e => setDelivery_date(e.target.value)}/>
                      <img src="./assets/imgs/down-arrow.png" alt="icon" />
                    </div>
                    <div className="input position-relative d-flex ">
                      <input type="text" placeholder="شروط التسليم" 
                      value={delivery_term} onChange={e => setDelivery_term(e.target.value)}/>
                      <img src="./assets/imgs/down-arrow.png" alt="icon" />
                    </div>
                    <div className="input position-relative d-flex ">
                    ...
                    <div className="input position-relative d-flex ">
                      <input type="text" placeholder="طريقة الدفع" 
