...
import { Add, adNavigate, MOBILE_URL } from "../../config";
import API from "../../API"
...
export default function Page23() {
  ...
  const ad_type = "mobile"

  const [messages, setMessages] = useState('');
  const handleSubmit = async (event) => {
    event.preventDefault();
    var request = new FormData();
    var { ad_name, description, payment, condition, warranty, brand, type, price } = document.forms[1];    
    if (!isUserLogin) {
    ...
    const response = await API.postRequest(MOBILE_URL, Add, request)
              ...
              <form onSubmit={handleSubmit} className="inputs ">
                ...
                <div className="search mt-3 mb-2 reset-inputs">
                  ...
                  <div className="inputs d-grid-2">
                    ...
                    <div className="input position-relative d-flex ">
                      <input type="text" name="brand" placeholder="الماركة" />
                      <img src="./assets/imgs/down-arrow.png" alt="icon" />
                    </div>
                    <div className="input position-relative d-flex ">
                    ...
                    <div className="input position-relative d-flex ">
                      <input type="text" name="warranty" placeholder="الضمان" />
                      <img src="./assets/imgs/down-arrow.png" alt="icon" />
                    </div>
                  </div>
                </div>
