...
import { AD_URL, Edit, MOBILE_URL } from "../../config";
import API from "../../API"
...
export default function Page23() {
  ...
  const handleSubmit = async (event) => {
    ...
    request.append('warranty', warranty)
    request.append('payment', payment)
    const response = await API.editRequest(MOBILE_URL, location.state.ad_id, Edit, request);
  ...
  useEffect(()=>{
    API.getBy(MOBILE_URL, location.state.ad_id)
    .then(response => {
              ...
              <form onSubmit={handleSubmit} className="inputs ">
                ...
                <div className="type">
                  ...
                  <div className="input position-relative d-flex ">
                    {<input type="text" value="موبايلات" />}
                ...
                <div className="search mt-3 mb-2 reset-inputs">
                  ...
                  <div className="inputs d-grid-2">
                    ...
                    <div className="input position-relative d-flex ">
                      <input type="text" placeholder="الماركة"
                    ...
                    <div className="input position-relative d-flex ">
                      <input type="text" placeholder="الضمان" />
                      <img src="./assets/imgs/down-arrow.png" alt="icon" />
                    </div>
                  </div>
                </div>
