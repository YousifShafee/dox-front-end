...
import { Add, PROPERTIES_SALES_URL } from "../../config";
import API from "../../API"
...
export default function Page18() {
  ...
  const handleSubmit = async (event) => {
    ...
    var { ad_name,bedroom,bathroom,type,compound,price,payment,delivery_date,area,delivery_term,description } = document.forms[0];    
    if (!isUserLogin) {
    ...
    request.append('ad_type', "property_sales")
