...
import { Add, adNavigate, PROPERTIES_SALES_URL } from "../../config";
import API from "../../API"
...
export default function Page18() {
  ...
  const ad_type = "property_sales"

  const [messages, setMessages] = useState('');
  const handleSubmit = async (event) => {
    event.preventDefault();
    var request = new FormData();
    var { ad_name,bedroom,bathroom,type,compound,price,payment,delivery_date,area,delivery_term,description } = document.forms[1];    
    if (!isUserLogin) {
    ...
    const response = await API.postRequest(PROPERTIES_SALES_URL, Add, request)
              ...
              <form onSubmit={handleSubmit} className="inputs ">
                ...
                <div className="search mt-3 mb-2 reset-inputs">
                  ...
                  <div className="inputs d-grid-2">
                    <div className="input position-relative d-flex ">
                      <input name="price" type="text" placeholder="السعر" />
                      <img src="./assets/imgs/down-arrow.png" alt="icon" />
                    </div>
                    <div className="input position-relative d-flex ">
