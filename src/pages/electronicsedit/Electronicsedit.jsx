...
import { AD_URL, Edit, ELECTRONIC_URL } from "../../config";
import API from "../../API";
...
export default function Page23() {
  ...
  const handleSubmit = async (event) => {
    ...
    const response = await API.editRequest(ELECTRONIC_URL, location.state.ad_id, Edit, request);
  ...
  useEffect(() => {
    API.getBy(ELECTRONIC_URL, location.state.ad_id)
      .then((response) => {
              ...
              <form onSubmit={handleSubmit} className="inputs ">
                ...
                <div className="type">
                  ...
                  <div className="input position-relative d-flex ">
                    {<input type="text" value="الكترونيات" />}
                ...
                <div className="search mt-3 mb-2 reset-inputs">
                  <div className="position-relative btn-icon">
                    <span className="mr-1 fs-1">الكترونيات</span>
                    <img
                      src="./assets/imgs/electronics.png"
                      alt="electronics"
                      className=""
